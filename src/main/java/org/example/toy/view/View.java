package org.example.toy.view;

import org.example.toy.controller.Controller;
import org.example.toy.modul.NewFolder;
import org.example.toy.modul.SaveData;
import org.example.toy.modul.Shop;
...
public class View {
    public void start() throws NewFolder {
        Shop shop = new Shop();
        List<Toy> toyList = new ArrayList<>();
        Scanner scanner = new Scanner(System.in);
        System.out.println("Добро пожаловать!" + "\n" + "Администратирование игравого автомата.");
        System.out.println("Загрузите игрушки в автомат");
