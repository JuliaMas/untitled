...
public class SaveUser implements SaveUserInt {
    @Override
    public String saveUser(User user) throws NoFolder {
        String str = user.toString() + "\n";
        String path = "D:\\Обучение\\Java\\untitled\\src\\main\\java\\" +
                "org\\example\\exceptions\\homeWork_3\\data\\" + user.getname() + ".txt";
        if (!checkFile(path)) {
            ...
            try {
                ...
                new File("D:\\Обучение\\Java\\untitled\\src\\main\\java\\" +
                        "org\\example\\exceptions\\homeWork_3\\data\\").mkdirs();
                throw new NoFolder();
